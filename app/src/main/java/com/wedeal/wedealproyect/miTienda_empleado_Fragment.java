...
public class miTienda_empleado_Fragment extends Fragment {
    TabItem info,clientes;
    ViewPager viewPager;
    TabLayout tablayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_mitiendaempleado, container, false);
